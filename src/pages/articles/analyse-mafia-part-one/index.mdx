...
description: ""
---
![Marlon Brando in The Godfather](./gf-brando-kiss.jpg)
...
![Goodfellas quote](./goodfellas-as-far-back-quote.gif)
...
![Mafia: The Government’s Secret File on Organized Crime book](./mafia-book.jpg)
...
![Joe Bonnano's entry in the FBN Organized Crime book](./joe-bonnano-details.png)
...
In [Part 2](/articles/analyse-mafia-part-two) of this series we will get into Data Wrangling and try to overcome some of the issues we find in working with unstructured text data.
