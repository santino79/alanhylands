...
description: ""
---
![Marlon Brando black and white photo from The Godfather](./gf-brando-bw.jpg)

## THE STORY SO FAR

In [Part Two](/articles/analyse-mafia-part-two) we began our data wrangling process. We set out our plan of attack and successfully broke the unclean raw data down into more manageable chunks.
...
![Screenshot of DESCRIPTION field from raw Mafia data](./mafia-ss2.png)
