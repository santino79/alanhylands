...
description: ""
---
![Marlon Brando listens to a whispered request in The Godfather](./gf-brando-listen.jpg)

## THE STORY SO FAR

In [Part One](/articles/analyse-mafia-part-one/) of our **Analysing The Mafia with Python** series, we:
...
df
```
![Screenshot of Jupyter Notebook output from Pandas code](./mafia-ss1.png)
...
In [Part Three](/articles/analyse-mafia-part-three) we will take our new structured  output file and start to get creative on the **DESCRIPTION** field. We'll introduce **Regular Expressions** to pull out the different data points such as Height, Weight, Eye Colour and more.
