...
description: ""
---
![Tile with number five on it](./number-five-tile.jpg)
...
![White PVC Pipes](./white-pipes.jpg)
...
![Magnifying glass on keyboard](./magnifying-glass.jpg)
...
![Man in dark working on laptops](./dark-laptops.jpg)
...
![Fairy lights on a book](./book-fairy-lights.jpg)
...
![Man in dark in black suit and hat](./dark-spy.jpg)
...
(Main photo by [Franck V.][3] on [Unsplash][4])
 ...
 [1]: https://alanhylands.com/articles/generalists-real-data-science-unicorns/
 [2]: https://alanhylands.com/articles/is-sql-really-a-game-changer-for-data-science-careers/
