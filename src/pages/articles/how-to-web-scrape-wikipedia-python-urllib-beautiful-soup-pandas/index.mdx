...
description: ""
---
![Screen Scrape Tutorial](./screen-scrape-tutorial_800w.jpg)
...
(If you don’t have Anaconda or Jupyter Notebook installed on your Windows machine, check out our tutorial [How Do I Install Anaconda On Windows](/articles/how-install-anaconda-windows/)? before getting started. If you’re on Linux or Mac OS X you’ll have to Google it. Bill Gates fanboy in the house.…)
...
![Start Scraping Tutorial 1](./sstut_1.png)
...
![Start Scraping Tutorial 2](./sstut_2.png)
...
![Start Scraping Tutorial 3](./sstut_3.png)
...
![Start Scraping Tutorial 4](./sstut_4.png)
...
![Start Scraping Tutorial 5](./sstut_5.png)
...
![Start Scraping Tutorial 6](./sstut_6.png)
