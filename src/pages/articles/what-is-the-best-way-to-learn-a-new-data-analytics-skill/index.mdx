...
description: ""
---
![Library Lights](./library-lights.jpg)
...
Someday I may even write it all up as a case study and finish the job properly. (**EDIT:** I finally bit the bullet and started writing out how I approached the full project. For a walkthrough with code and data check out [Analysing The Mafia: Part One](/articles/analyse-mafia-python-part-one).)
...
Send me your experiences and observations, I’d love to see how it is for everyone else out there.
 ...
 [4]: https://alanhylands.com/articles/should-i-feel-nervous-that-the-data-world-is-changing/
